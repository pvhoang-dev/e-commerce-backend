                                        ...
                                        <tr class="table_row cart_item" data-id="">
                                            <td class="column-1">
                                                <div class="how-itemcart1">
                                                    <img src="{{ route('file.show', 3) }}" alt="IMG">
                                                </div>
                                            </td>
                                            ...
                                            <td class="column-4">
                                                <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                    ...
                                                    <input class="mtext-104 cl3 txt-center num-product" type="number"
                                                        name="num-product1" value="{{ $value['quantity'] }}">
                                            ...
                                            <td class="column-5">{{number_format($value['price']*$value['quantity'])}}</td>
                                        </tr>
                                        @php
                            ...
                            <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                <div>
                                    <p class="stext-111 cl6 p-t-2">
                                        Shopping to
                                        <strong class="address-detail">thôn Nam Khánh, xã Mỹ Thuận, huyện Mỹ Lộc, tỉnh Nam
                                            Định</strong>
                                    </p>
                                    ...
                                    <div class="p-t-15">
                                        ...
                                        <div class="form-group district">
                                            <select name="cart_district" id="select-district"
                                                class="form-control select-district" data-placeholder="Select a district">
